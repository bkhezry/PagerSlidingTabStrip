...
public class PagerSlidingTabStrip extends HorizontalScrollView {
  ...
  private boolean isTabLayoutRightSide = false;
  ...
  public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
    ...
    isTabLayoutRightSide = a.getBoolean(R.styleable.PagerSlidingTabStrip_pstsTabLayoutRightSide, false);
    ...
    a.recycle();
    if (isTabLayoutRightSide) {
      mTabsContainer.setGravity(Gravity.END);
    }
